...
public class GenerateData {
    ...
    private static AppStartupLog[] initAppStartupLogs() {
        ...
        for (int i = 0; i < 10; i++) {
            ...
            appStartupLog.setLogType(Constants.TOPIC_APP_STARTUP);
    ...
    private static AppPageLog[] initAppPageLogs() {
        ...
        for (int i = 0; i < 10; i++) {
            ...
            appPageLog.setLogType(Constants.TOPIC_APP_PAGE);
    ...
    private static AppEventLog[] initAppEventLogs() {
        ...
        for (int i = 0; i < 10; i++) {
            ...
            appEventLog.setLogType(Constants.TOPIC_APP_EVENT);
            //事件唯一标识
            ...
            // 事件参数
            appEventLog.setParamMap(paramKeyValueMapsS[random.nextInt(paramKeyValueMapsS.length)]);
    ...
    private static AppUsageLog[] initAppUsageLogs() {
        ...
        for (int i = 0; i < 10; i++) {
            ...
            appUsageLog.setLogType(Constants.TOPIC_APP_USAGE);
    ...
    private static AppErrorLog[] initAppErrorLogs() {
        ...
        for (int i = 0; i < 10; i++) {
            ...
            appErrorLog.setLogType(Constants.TOPIC_APP_ERRROR);
            //错误摘要
